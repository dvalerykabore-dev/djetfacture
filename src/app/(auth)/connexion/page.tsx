    ...
    <div className="min-h-screen bg-canvas flex items-center justify-center p-4 font-sans text-ink">
      <div className="bg-surface rounded-card p-8 md:p-10 border border-slate-200 shadow-float max-w-md w-full space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <h1 className="text-2xl font-black text-ink tracking-tight">Espace Client DJETFACTURE</h1>
          <p className="text-xs text-muted">Connectez-vous pour accéder à votre comptabilité et émettre vos factures FCFA</p>
        </div>
        ...
        <form className="space-y-4 text-xs">
          ...
          <div>
            <div className="flex justify-between items-center mb-1">
              ...
              <Link href="/mot-de-passe-oublie" className="text-brand-700 font-semibold hover:underline">
                Oublié ?
              </Link>
            </div>
            <div className="relative">
        ...
        <div className="pt-4 border-t border-slate-100 text-center text-xs text-muted">
          ...
          <Link href="/inscription" className="font-bold text-brand-900 hover:underline">
